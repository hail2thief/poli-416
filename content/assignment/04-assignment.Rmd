...
3. What is the relationship between a county’s unemployment rate and its a military service? Plot them together (x-axis = unemployment rate) and add a trend line so you can see the general trend. Roughly, what is that trend? 
