...
Look at the political cartoon below, from 1996, depicting Colombian presidential candidate Ernesto Samper. Do some digging around online, and discuss the meaning and intention of **each** cartoon (3-4 sentences per cartoon). Some guiding questions:
...
3. Google what Benford's Law is and it's role in the detection of fraud. In your own words, briefly describe Benford's Law and how someone could use Benford's Law to detect irregularities in data. (3-4 sentences)
...
- Next, using a pivot table, COUNT the number of times each pair of first digits appears in the dataset.
...
6. There is a pair of digits that violates Benford's Law. What pair of digits is it? Write them as a number (e.g., 23). 
