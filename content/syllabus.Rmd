...
<span class="newthought">There are over 50 armed conflicts in the world today.</span> [^courseinfo] Persistent, low-level forms of violence affect an even broader set of countries, preventing people from living full and free lives. 

In this class, you'll learn about *why* violence plagues some places but not others, *how* the use of violence is shaped by strategic considerations, and *what* consequences violence has for civilians caught in the cross-fire. 


We will draw from political science, economics, history, journalism, ethnography, fiction, documentaries, and in-class simulations to develop an understanding of political violence as a theoretical concept, and how people around the world experience it. You should expect to do **a lot** of reading in this course. 
...
1. Identify the structural and historical origins of violence
2. Think about armed conflict as a strategic process involving states, civilians, and armed groups
3. Discuss three prominent cases of sustained political violence in the contemporary era
4. Understand the limitations of policy aimed at building peace and order 
...
<span class="newthought">If you think you received the wrong grade</span>, you will need to submit a memo (hard-copy) giving specific detail about why the grade should be changed. I will then **re-grade the entire assignment**. 
...
[^propaganda] <span class="newthought">Once you have read</span> this entire syllabus and [the assignments page](/assignments/), please post some propaganda from any war or rebel group to the Slack (2 bonus points).
