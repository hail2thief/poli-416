...
<span class="newthought">There are over 50 ongoing armed conflicts in the world today.</span> [^courseinfo] Persistent, low-level forms of violence affect even more countries, preventing people from living full and free lives. 

In this class, you'll learn about *why* violence plagues some places more than others, *how* strategy and local conditions shape the way armed actors wield violence, and *what* consequences violence has for civilians living in the cross-fire. 
...
1. Identify the structural and historical sources of violence
2. Think about armed conflict as a strategic process involving states, civilians, and armed groups
3. Competently discuss three prominent cases of sustained violence in the contemporary era
...
<span class="newthought">Slack will be our main mode of communication.</span> We have a class Slack channel where anyone in the class can ask questions and anyone can answer. Ask questions about the readings (e.g., "What does the author mean here...?") or class logistics (e.g., "I can't find the reading") in the class Slack workspace. 
