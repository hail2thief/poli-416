...
In this class, you'll learn about *why* violence plagues some places more than others, *how* strategy and local conditions shape the way armed actors wield violence, and *what* consequences violence has for people living in the cross-fire. 
...
You should expect to do **a lot** of reading in this course. 
...
1. Identify structural and historical causes of violence
...
Of course, you can email if there is some time-pressing emergency (e.g., I accidentally listed the same reading twice on some day). I also understand that some people may commute or have other difficulties coming to office hours. If you **must** email, please: 
...
3. Do not email to ask what you missed during a missed class
...
[^propaganda] <span class="newthought">Once you have read</span> this entire syllabus and [the assignments page](/assignments/), please post some propaganda from any war or rebel group to the Slack by September 1st (2 bonus points).
